...
The current version does not persist map positions, selected locations, or usage history. Time-zone boundary geometry is bundled with the app and does not contain personal information.
...
This policy may be updated if the app's features or data practices change. The revision date at the top identifies the latest version.
